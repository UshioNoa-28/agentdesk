...
class _FakeMemoryCatalog:
    def load_prompt(self) -> str:
        return "- user layer: /tmp/memory/user\n- project layer: /tmp/memory/project"
...
class _ServiceFixture:
    def __init__(
        ...
        *,
        ...
        # 老版本入库的根会话 SYSTEM 行：现拼架构下它只作历史遗留，投影时被切除
        ...
        catalog = SimpleNamespace(current_profile=lambda: ModelProfile(context_window=200_000))
        ...
        context_manager = ContextManager(
            ...
            memory_catalog=_FakeMemoryCatalog(),
        )
        ...
        self.runtime = AgentRuntimeManager(
            ...
            factory=AgentFactory(
                scopes=self.scopes, status_registry=InMemoryAgentStatusRegistry()
            ),
            scopes=self.scopes,
